...
{ 
    ...
    if (text_ground_flag == 0) aux_color = aux_color;	
	else if (text_ground_flag == 1) aux_color = aux_color*texture(texture_2D,texCoord);	
	else
		aux_color = texture(texture_2D,texCoord);
